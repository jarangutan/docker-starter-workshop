...
To stop our application from running, lets run a command using the name we gave the container `"tiny_app"`
```bash
docker stop tiny_app
```

We should see the name `tiny_app` pop up in our terminal
